...
import de.wsh.testcortextdecoder.databinding.ActivityScanBinding
import pub.devrel.easypermissions.EasyPermissions


class ScanActivity : AppCompatActivity(), EasyPermissions.PermissionCallbacks,
    CortexDecoderLibraryCallback, LicenseCallback {
...
//Easy Permission
    ...
    override fun receivedMultipleDecodedData(
        ...
        Log.d(TAG, "receivedMultipleDecodedData")

    }

    override fun receivedDecodedCodewordsData(p0: Codewords?) {
        Log.d(TAG, "receivedDecodedCodewordsData")

    }

    override fun onDeviceIDResult(p0: Int, p1: String?) {
        Log.d(TAG, "onDeviceIDResult")
